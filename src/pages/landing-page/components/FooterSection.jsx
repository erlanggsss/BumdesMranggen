...
const FooterSection = () => {
  ...
  const handleWhatsAppContact = () => {
    const message = encodeURIComponent('Halo! Saya tertarik untuk mengetahui lebih lanjut tentang BUMDes Mranggen.');
      ...
      <div className="bg-primary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="font-poppins font-bold text-2xl sm:text-3xl text-white mb-4">
            Dapatkan Update Terbaru BUMDes Mranggen
          </h3>
          <p className="font-inter text-white/90 mb-8 max-w-2xl mx-auto">
            Berlangganan newsletter kami untuk mendapatkan informasi terbaru tentang program, produk, dan perkembangan BUMDes Mranggen
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="text-center md:text-left">
              <p className="font-inter text-gray-400 text-sm">
                © {currentYear} BUMDes Makmur Sejahtera. Seluruh hak cipta dilindungi undang-undang.
              </p>
            </div>
