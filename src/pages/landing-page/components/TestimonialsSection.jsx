...
const TestimonialsSection = () => {
  ...
  const testimonials = [
  {
    ...
    content: `Sejak bergabung dengan BUMDes Gotong Royong Sejahtera, pendapatan keluarga saya meningkat 200%. Program pelatihan pertanian organik sangat membantu meningkatkan kualitas hasil panen. Sekarang produk saya bisa dijual dengan harga yang lebih baik.`,
    rating: 5,
  ...
  },
  {
    ...
    content: `Kemitraan dengan BUMDes Gotong Royong Sejahtera sangat menguntungkan. Mereka konsisten dalam kualitas produk dan tepat waktu dalam pengiriman. Tim manajemen yang profesional membuat kerjasama berjalan lancar dan saling menguntungkan.`,
    rating: 5,
    location: 'Jakarta',
  ...
  },
  {
    ...
    content: `Paket wisata desa dari BUMDes Gotong Royong Sejahtera menjadi favorit tamu hotel kami. Pengalaman autentik yang ditawarkan sangat berkesan. Kerjasama ini membuka peluang wisata alternatif yang unik dan berkualitas tinggi.`,
    rating: 5,
    location: 'Semarang',
  ...
  },
  {
    ...
    content: `BUMDes Gotong Royong Sejahtera menjadi model percontohan di tingkat kabupaten. Transparansi pengelolaan dan dampak positif terhadap ekonomi masyarakat sangat luar biasa. Ini adalah contoh nyata keberhasilan program pemberdayaan ekonomi desa.`,
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-inter text-lg text-gray-600 max-w-3xl mx-auto">
            Dengarkan langsung pengalaman dan kesuksesan masyarakat serta mitra bisnis yang telah bergabung dengan BUMDes Gotong Royong Sejahtera
          </p>
        </div>
        ...
        <div className="text-center">
          <div className="bg-primary rounded-3xl p-8 text-white">
            ...
            <p className="font-inter text-white/90 mb-6 max-w-2xl mx-auto">
              Jadilah bagian dari komunitas BUMDes Gotong Royong Sejahtera dan rasakan sendiri dampak positifnya bagi kehidupan dan usaha Anda
            </p>
            <Button
              variant="outline"
              size="lg"
