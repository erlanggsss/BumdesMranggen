...
const ProgramsTimelineSection = () => {
  ...
  const programs = [
  {
    ...
    description: 'Pembentukan BUMDes Gotong Royong Sejahtera dengan modal awal dari pemerintah desa',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-inter text-lg text-gray-600 max-w-3xl mx-auto">
            Perjalanan transformasi BUMDes Gotong Royong Sejahtera dalam membangun ekonomi desa yang berkelanjutan dan berdampak positif bagi masyarakat
          </p>
        </div>
