...
const LocationSection = () => {
  ...
  const handleWhatsAppContact = (phone, locationName) => {
    const message = encodeURIComponent(`Halo! Saya ingin mengetahui lebih lanjut tentang layanan di ${locationName} BUMDes Mranggen.`);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-inter text-lg text-gray-600 max-w-3xl mx-auto">
            Kunjungi berbagai unit usaha BUMDes Mranggen yang tersebar di seluruh desa untuk mendapatkan layanan terbaik
          </p>
        </div>
        ...
        <div className="mt-16 bg-primary rounded-3xl p-8 text-center text-white">
          ...
          <Button
            variant="outline"
            size="lg"
            onClick={() => handleWhatsAppContact('+62 812-3456-7890', 'BUMDes Mranggen')}
            iconName="MessageCircle"
            iconPosition="left"
